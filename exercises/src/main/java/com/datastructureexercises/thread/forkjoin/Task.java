package com.datastructureexercises.thread.forkjoin;
...
public class Task extends RecursiveAction {
    ...
    public static void main(String[] args) {
        ...
        for (int m = 0; m < taskCount; m++) {
            Task task = new Task(countDownLatch, list, m);
            RecursiveAction recursiveAction = YmsContextWrappers.wrapRecursiveAction(task);
        ...
        } catch (java.lang.InterruptedException | RuntimeException ie) {
            ie.printStackTrace();
            // 销毁动态线程池
